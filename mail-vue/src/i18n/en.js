const en = {
    ...
    brevoWebhookSecret: 'Brevo Webhook Secret',
    brevoWebhookSecretPlaceholder: 'Enter a secret, or leave empty to disable the webhook',
    brevoWebhookSecretDesc: 'Initially seeded from BREVO_WEBHOOK_SECRET during the first upgrade. Saved settings take precedence afterward.',
    ...
    fileTooLarge64: 'Skipped {count} file(s). Each file must be larger than 0 and no more than 64 MB',
    attachmentCountLimit: 'Skipped {count} file(s). Each email supports up to 10 regular attachments',
    fileUploadFailedTitle: 'File upload failed',
    fileUploadFailed: 'Could not upload {name}: {message}',
    uploadingFiles: 'Files are still uploading. Please wait',
    ...
    migrateKvAttachments: 'Migrate KV Attachments',
    migrateKvAttachmentsDesc: 'Copy KV objects whose keys start with attachments/ to R2 in batches. Keys, filenames, and content types are preserved; KV data is not deleted.',
    migrateKvAttachmentsConfirm: 'Copy all KV attachments to R2 now? This operation is repeatable and does not delete the original KV data.',
    startMigration: 'Start Migration',
    migratingAttachments: 'Migrated {count}',
    migrateKvAttachmentsSuccess: 'Migration complete: {migrated} copied, {skipped} skipped',
    migrateKvAttachmentsFailed: 'Migration stopped: {message}',
    backfillImageUrls: 'Backfill historical image URLs',
    backfillImageUrlsDesc: 'Rewrite leftover cid: references and stale absolute R2 URLs in stored emails to the {{domain}}key placeholder so the frontend can render them.',
    backfillImageUrlsConfirm: 'Start rewriting image URLs in historical emails? A dry-run scan is recommended first to review the affected rows.',
    startBackfill: 'Start backfill',
    backfillImageUrlsScanning: 'Scanning: {count} rows inspected',
    backfillImageUrlsWriting: 'Writing: {count} rows updated',
    backfillImageUrlsSuccess: 'Backfill complete: scanned {scanned}, rewritten {rewritten}, skipped {skipped}, failed {failed}',
    backfillImageUrlsFailed: 'Backfill stopped: {message}',
    backfillImageUrlsFailedRefs: 'Backfill stopped: {message} (email_id {emailId}, unresolved cid refs: {refs})',
    ...
    managedDomainsTitle: 'Email Domains & Admin',
    managedDomains: 'Allowed Email Domains',
    managedDomainsDesc: 'When users register, log in, or add a mailbox, the email suffix must be in this list.',
    adminEmails: 'Super Admin Emails',
    adminEmailsDesc: 'Admin emails with full permissions. Add multiple entries; remove one to revoke that admin.',
    atLeast: 'At Least',
    character: '',
    ...
    sync: 'Sync',
    syncing: 'Syncing...',
    syncConfirm: 'Fetch emails and their latest statuses from the providers?',
    syncSuccess: 'Sync complete. Added {inserted}, updated {updated}, skipped {skipped}',
