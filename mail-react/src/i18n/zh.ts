const zh = {
  ...
  noCodeFound: '没有任何注册码',
  noRegKeyFound: '暂无注册码',
  noRegKeyFoundDesc: '注册码用来控制谁能注册账号。创建一个以开放注册。',
  noRoleFound: '暂无角色',
  noRoleFoundDesc: '角色用来控制谁能做什么。创建一个以分配权限。',
  noSignatureFound: '暂无签名',
  useHistory: '使用记录',
  date: '时间',
  roleDesc: '权限身份',
  noSubject: '无主题',
  ...
  cancel: '取消',
  undo: '撤销',
  undoRemoveStar: '已取消星标',
  noMessagesFoundDesc: '该邮件已不可用，可能已被删除，或者你从一个失效的链接进入了这里。',
  backToInbox: '返回收件箱',
  notFound: '页面不存在',
  notFoundDesc: '你访问的页面不存在或已被移动。',
  delDraftsTitle: '删除草稿',
  deleteDraftsConfirm: '确认删除 {count} 个草稿？此操作不可撤销',
  attachmentTooLarge: '已跳过 {count} 个文件（单个超过 25 MB 或总大小超过 50 MB）',
  delRoleTitle: '删除角色',
  ...
  searchSender: '搜索发件人',
  userEmail: '用户邮箱',
  loginHeroTitle: '一个安静的邮箱。',
  loginHeroSubtitle:
    '无服务器、邀请制、多租户。支持自定义域名，部署在 Cloudflare 之上。',
  loginChipServerless: '无服务器',
  loginChipInvite: '邀请制',
  loginChipCustomDomain: '自定义域名',
  bindEmailPrompt: '请注册并绑定一个邮箱。',
  bindEmailTitle: '绑定邮箱',
  bind: '绑定',
  viewOnGitHub: '在 GitHub 查看',
  analyticsSubtitle: '实时统计、发送量，以及用户与邮箱的增长趋势。',
  myMailboxes: '我的邮箱',
  sharedWithMe: '已共享给我',
  ...
  mailboxOwner: '所有者',
  memberCount: '成员',
  adminAddMailbox: '代添加邮箱',
  adminRenameMailbox: '代重命名邮箱',
  adminDeleteMailbox: '代删除邮箱',
  cannotShareOwner: '不能将所有者添加为成员',
  cannotAddSelf: '不能添加自己为成员',
  memberSelfAccount: '不能共享主邮箱',
  permViewer: '查看者',
  permSender: '发件者',
  permAdmin: '管理员',
  mailboxRole: '我的权限',
